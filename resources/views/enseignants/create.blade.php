                        ...
                        <div class="row">
                            ...
                            <div class="col-sm-6">
                                <div class="form-group">
                                    ...
                                    <input placeholder="+225 0506439352" id="mobile_number" type="tel" maxlength="15"
                                        ...
                                        required value="{{old('telephone')}}" title="+225 0107781234">
                            ...
                            <div class="col-sm-6">
                                <div class="form-group">
                                    ...
                                    <select class="form-control @error('discipline') is-invalid @enderror select2"
                                        name="discipline[]" value="{{old('discipline[]')}}" multiple
