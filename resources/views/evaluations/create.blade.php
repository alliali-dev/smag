    ...
    <div class="row">
        <div class="col-xl-12 col-xxl-12 col-sm-12">
            <div class="card">
                ...
                <div class="card-body">
                    <form action="{{route('evaluations.store')}}" method="post" id="addEvalForm"
                                ...
                                <div class="col-6">
                                    <div class="form-group">
                                        ...
                                        <select class="form-select @error('periode') is-invalid @enderror"
                                            name="periode" value="{{old('periode')}}" id="periodeFromYear">
                                ...
                                <div class="col-6">
                                    ...
                                    <div class="form-group">
                                        ...
                                        <input type="radio" class="form-radio @error('discipline') is-invalid @enderror"
                                            name="discipline" id="{{'discipline'.$item->codeMat}}"
                                            value="{{$item->codeMat}}" checked>
                                        <label
                                            for="{{'discipline'.$item->codeMat}}">{{$item->matiere}}</label>&nbsp;&nbsp;
                                        @empty
                                        @endforelse
                                        @endif
                                        @empty
                                ...
                                <div class="col-6">
                                    <div class="form-group">
                                        ...
                                        <input type="number" min="1" max="8" size="1"
                                            class="form-control @error('coef_disc') is-invalid @enderror"
                                            name="coef_disc" value="{{old('coef_disc')}}" id="coef_disc"
                                            placeholder="1">
