    ...
    <div class="row page-titles mx-0">
        ...
        <div class="col-sm-6 p-md-0 justify-content-sm-end mt-2 mt-sm-0 d-flex">
            <ol class="breadcrumb">
                ...
                <li class="breadcrumb-item"><a href="{{route('classes.index')}}">Classe</a></li>
        ...
        <div class="col-xl-12 col-xxl-12 col-sm-12">
            <div class="card">
                <div class="card-header">
                    <h5 class="card-title">Formulaire d&acute;ajout d&acute;une classe</h5>
                        ...
                        <div class="row">
                            ...
                            <div class="col-sm-2">
                                <div class="form-group">
                                    ...
                                    <select name="effectif" id="effectif"
                                        class="form-select @error('effectif') is-invalid @enderror" required
                                        value="{{old('effectif')}}">
