@extends('layouts.app')
@section('title','Liste des series')
@section('content')
<div class="container-fluid">
    <div class="row page-titles mx-0">
        <div class="col-sm-6 p-md-0">
            <div class="welcome-text">
                <h4>S&eacute;ries <span class="text text-danger" id="">({{count($series)}})</span></h4>
            </div>
        </div>
        <div class="col-sm-6 p-md-0 justify-content-sm-end mt-2 mt-sm-0 d-flex">
            <ol class="breadcrumb">
                <li class="breadcrumb-item"><a href="javascript:void(0);">S&eacute;rie</a></li>
                ...
                <div id="list-view" class="tab-pane fade active show col-lg-12">
                    <div class="card">
                        <div class="card-header">
                            <h4 class="card-title">S&eacute;ries<span class="text text-danger"
                                    id="">({{$series->total()}})</span></h4>
                            <a href="{{route('series.create')}}" class="btn btn-primary">+ Ajouter</a>
                        </div>
                        <div class="card-body">
                            <div class="table-responsive">
                                ...
                                <div class="row" style="float:right;">
                                    <nav class="nav text-right">{{$series->links('pagination::bootstrap-4')}}</nav>
                                </div>
                            </div>
                        </div>
                    </div>
